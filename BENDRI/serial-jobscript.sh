...
module load compilers/gcc/4.6.2 parallel/openmpi/gcc/1.4.4
mkdir /scratch/ruslan

cp -r /home/ruslan/performance_test/iozone3_405 /scratch/ruslan/
cd /scratch/ruslan/iozone3_405/src/current 
make linux-AMD64
cd ../../../
...
sleep 3
./iozone3_405/src/current/iozone -e -r 4k -s 512M -i0 -i1 -i2 -i3 -i4 -i5 -i6 -i7 -i8 -i9 -i10 -i11 -i12 


sleep 3
./iozone3_405/src/current/iozone -e -r 64k -s 512M -i0 -i1 -i2 -i3 -i4 -i5 -i6 -i7 -i8 -i9 -i10 -i11 -i12 

sleep 3
./iozone3_405/src/current/iozone -e -r 1024k -s 512M -i0 -i1 -i2 -i3 -i4 -i5 -i6 -i7 -i8 -i9 -i10 -i11 -i12 
